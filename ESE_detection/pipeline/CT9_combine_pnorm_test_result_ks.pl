...
foreach my $cancertype (@cancertypelist) {
	...
	my @sd = ();
	my @pval = ();
	my $pvalfile = "$workdir/$cancertype[1]/analysis_type1/Rtest_result_ks.txt";
	...
	my $datafile = "$workdir/$cancertype[1]/analysis_type1/ese_judge.txt";
	my $outputfile = "$workdir/$cancertype[1]/analysis_type1/ese_judge_pval_ks.txt";
