...
How to run codes
(1)Please designate file and directory path in /ESE_detection/pipeline/pipeline.sh.
...
$ sh ./(Path to ESE_detection)/pipeline/pipeline.sh

(4)Identified ESE-disrupting variants are output in "All_validated_ese_Seq_ks.txt" file.

(5)After ESE detection finished, you can run permutation test. Please designate workdir directory in /ESE_detection/permutation_test_pipeline/permutation_test_pipeline_all.sh and run permutation_test_pipeline_all.sh.
